...
public class cheepItem {
    ...
    public void getresult(WebDriver driver){
        ...
        for (int i=0;i<(prices.size());i=i+1){
            Item phone = new Item();
            phone.setItem(prices.get(i).getText(),titles.get(i).getText());
    ...
    /*
    @Attachment(value = "Cheep item", type = "text")
    public static String getnameandprice (String name,String price) throws IOException {
